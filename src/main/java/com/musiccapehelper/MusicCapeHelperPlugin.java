...
import com.musiccapehelper.ui.rows.MusicCapePanelRow;
...
public class MusicCapeHelperPlugin extends Plugin
{
	...
	public void rowClicked(MusicCapePanelRow row)
	{
	...
	public void rowHeaderClicked(MusicCapeHelperHeader row)
	{
